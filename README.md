...
Verify that the [name_of_project] folder was created and has boilerplate files such as **init**.py
...
Check by the name of your variable to make sure worked - `n’ We can use a built in function from models to save this to the database -`n.save()`
